...
/*
//[2022.09.30] 現状では未使用な機能（api.x.com/oauth2/tokenへのアクセス時のcookie削除、旧x("__tmdl=legacy")サポート）のコメントアウト
...
//                // ※ "__tmdl=legacy" が付いている場合、旧 x の HTML / API をコールするために User-Agent を変更
...
//                        // 参考：[ZusorCode/Goodx](https://github.com/ZusorCode/Goodx)
//                    }
//                    return element;
//                } );
//            }
